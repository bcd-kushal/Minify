...
import { MinifyIcon } from "../../../public/minifyIcon"
...
export default function HeaderLayout({ props }: { props?: { cpw?:string, cph?:string } }){
    ...
    return(
        <nav className={`w-[${tlw.w}] h-[${tlw.h}] flex gap-2 items-center justify-between px-[24px] py-[12px] backdrop-blur-md bg-[#fff5] border-b-[0.5px] sticky top-0 z-20`}>
            {/* NAME ============================= */}
