export default function FeaturesSection(){
    ...
    return(
        <section className="px-[24px] bg-[#4445] pt-[112px] pb-[80px] flex flex-col gap-5 items-stretch">
            ...
            <div className="flex flex-wrap gap-4 items-start justify-start pt-[30px]">
                {tags.map(tag => (
                    <div className="px-[16px] py-[10px] flex gap-3 items-center w-fit bg-[#4447] rounded-md hover:bg-white transition-all hover:transition-all hover:text-black">
